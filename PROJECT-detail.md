# PROJECT-detail.md — Skill 235: beach-cleaning-robot-design

## Executive Summary

`beach-cleaning-robot-design` is a professional-grade harness for Claude Code targeting the
**Beach-Cleaning Robotics & Coastal Engineering** domain. It transforms Claude into a domain-expert that delivers
...
|------|----------------|----------------|
| Practitioner | "Analyze Beach-Cleaning Robotics & Coastal Engineering case X" | Full evidenced report |
...
USER INPUT
    │
    ▼
[main.md — beach-cleaning-robot-design]
    │
    ...
    ├─► sub-core-analysis.md  → Design a beach-cleaning robot: optimize movement path against tidal currents, debris sensing, collection, autonomy, and reliability in the marine environment.
...
- **Role:** intake specialist for a Beach-Cleaning Robotics & Coastal Engineering engagement
...
- **Role:** Beach-Cleaning Robotics & Coastal Engineering data librarian
...
- **Purpose:** Design a beach-cleaning robot: optimize movement path against tidal currents, debris sensing, collection, autonomy, and reliability in the marine environment.
- **Role:** beach-cleaning robot & coastal-engineering designer
- **Inputs:** Beach characteristics, debris, budget, language.
- **Outputs:** Locomotion/collection + sensing/path + autonomy + reliability + scenarios.
- **Tools:** - Read (SECOND-KNOWLEDGE-BRAIN.md)
- WebFetch (robotics, coastal refs)
- Reasoning / robotics
- **Quality Gate:** Locomotion/collection chosen; path planning vs tide/current; autonomy & reliability addressed.
...
- **Role:** research librarian for Beach-Cleaning Robotics & Coastal Engineering
...
- **Role:** senior Beach-Cleaning Robotics & Coastal Engineering advisor
...
- **Quality Gate:** Conclusion is exactly one of: Production-Ready Design / Conditional (autonomy) / Harsh-Environment Risk / Inconclusive; disclosure appears before the conclusion.
...
```
1. User invokes /beach-cleaning-robot-design [query]
...
> Tạo Agent "Trợ lý Thiết kế và Lập trình Robot Quét rác bờ biển", tự động tối ưu hóa lộ trình di chuyển dựa trên dòng hải lưu, đưa ra các đề xuất cải tiến phần cứng dựa trên các phương pháp đánh giá uy tín trên thế giới và đưa ra các đề xuất, giải pháp cải tiến, không ngừng đi crawl data từ các nghiên cứu robot học môi trường hoặc document uy tín liên quan để cập nhật kiến thức cho Agent ngày càng tốt hơn, xu hướng hơn.
