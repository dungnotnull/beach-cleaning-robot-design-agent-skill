"""
run_test_scenarios.py â€” Skill 235: beach-cleaning-robot-design
...
SKILLS = ROOT / "skills"
GATES = ["U1","U2","U3","U4","U5","U6"] + [g["id"] for g in [{"id": "G1", "check": "Locomotion & collection mechanism chosen", "fix": "Choose locomotion/collection"}, {"id": "G2", "check": "Path planning vs tide/current", "fix": "Plan path vs tide"}, {"id": "G3", "check": "Autonomy & battery sized", "fix": "Size autonomy"}, {"id": "G4", "check": "Reliability (corrosion/water/sand) planned", "fix": "Plan reliability"}]]
VERDICTS = ["Production-Ready Design", "Conditional (autonomy)", "Harsh-Environment Risk", "Inconclusive"]
